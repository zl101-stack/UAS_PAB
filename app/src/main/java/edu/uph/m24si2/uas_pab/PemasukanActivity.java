...
public class PemasukanActivity extends AppCompatActivity {
    ...
    private static final String TYPE = "PEMASUKAN";

    // Kategori Pemasukan: [label, iconKey]
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Bind views
        tvTotal     = findViewById(R.id.tvTotalPemasukan);
        ...
        adapter = new TransactionAdapter(this, transactionList, new TransactionAdapter.OnItemActionListener() {
            @Override
    ...
    private void showTransactionDialog(Transaction existing) {
        ...
        tvDialogTitle.setText(editingId == null ? "Tambah Pemasukan" : "Edit Pemasukan");
        tvDialogTitle.setTextColor(getColor(R.color.income_header));

        // Field jumlah dengan format Rupiah otomatis
        ...
        if (existing != null) {
            // Hilangkan prefix "Rp " agar watcher tidak double-format
    ...
    private void saveTransaction(EditText etAmount, AutoCompleteTextView spinnerKategori,
        ...
        // Bersihkan format Rupiah → ambil angka saja
        ...
        // Cari icon key dari label kategori
        String categoryIcon = "lainnya_in";
        ...
        String msg = editingId == null ? "Pemasukan berhasil disimpan" : "Pemasukan berhasil diperbarui";
    ...
    private void showDeleteConfirm(Transaction t) {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Hapus", (dialog, which) -> {
                    ...
                    loadData();
                    View rootView = findViewById(android.R.id.content);
                    Snackbar.make(rootView, "Transaksi dihapus", Snackbar.LENGTH_SHORT).show();
                })
                .setNegativeButton("Batal", null)
                .show();
    }
    ...
    /**
     * Memformat input secara otomatis menjadi "Rp 1.000.000" saat pengguna mengetik.
     */
